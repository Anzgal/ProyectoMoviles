...
extension Videos360TableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let siguiente = segue.destination as! Videos360ViewController
        //let prueba = textoFila
        //siguiente.linkRecibido = self.tableArray[IndexPath.row]
        siguiente.linkRecibido = "http://all360media.com/wp-content/uploads/pano/laphil/media/video-ios.mp4"
